$(function () {
    ...
    $('.wsus__floating_cart_btn').on('click', function () {
        $('.wsus__mini_cart').addClass('.show_cart');
    });
    ...
    $(window).on('scroll', function () {
        ...
        if (scrolling > 300) {
            ...
            $('.wsus__floating_cart_btn').fadeIn(); // 👈 Aquí mostramos también el carrito flotante
        } else {
            $('.wsus__scroll_btn').fadeOut();
            $('.wsus__floating_cart_btn').fadeOut(); // 👈 Aquí lo ocultamos igual que el scroll
        }
    });
