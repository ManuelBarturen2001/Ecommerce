...
class shippedOrderDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('invocie_id')->title('ID Factura'),
            Column::make('customer')->title('Cliente'),
            Column::make('date')->title('Fecha'),
            Column::make('product_qty')->title('Cantidad Productos'),
            Column::make('amount')->title('Monto'),
            Column::make('order_status')->title('Estado Pedido'),
            Column::make('payment_status')->title('Estado Pago'),
            Column::make('payment_method')->title('Método Pago'),
