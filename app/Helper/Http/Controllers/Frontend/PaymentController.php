...
class PaymentController extends Controller
{
    ...
    public function storeOrder($paymentMethod, $paymentStatus, $transactionId, $paidAmount, $paidCurrencyName)
    {
        ...
        // Si es recojo en tienda, agregar información adicional
        if (isset($address['is_store_pickup']) && $address['is_store_pickup'] && isset($address['store_pickup_id'])) {
            $order->is_store_pickup = true;
            $order->store_pickup_id = $address['store_pickup_id'];
            $order->order_address = json_encode($address);
        } else {
            $order->is_store_pickup = false;
            $order->store_pickup_id = null;
            $order->order_address = json_encode($address);
        }
