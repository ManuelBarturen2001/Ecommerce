...
class PeruData
{
    ...
    /**
     * Obtener ciudades por departamento con sus códigos postales
     */
    public static function getCiudadesPorDepartamento($departamento)
    {
        $ciudades = [
            'Amazonas' => [
                'Chachapoyas' => '01001',
        ...
        // Si el departamento existe, devolver sus ciudades
        if (isset($ciudades[$departamento])) {
    ...
    /**
     * Obtener todas las ciudades con sus códigos postales
     */
    public static function getAllCiudades()
    {
        $allCiudades = [];
        foreach (self::getDepartamentos() as $departamento) {
            $ciudades = self::getCiudadesPorDepartamento($departamento);
            foreach ($ciudades as $ciudad => $codigoPostal) {
                $allCiudades[$ciudad] = [
