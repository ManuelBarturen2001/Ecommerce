...
/** Gender Route */
Route::put('gender/change-status', [GenderController::class, 'changeStatus'])->name('gender.change-status');
Route::resource('gender', GenderController::class);

/** Shipping Rate Distance */

Route::put('shipping-rate-distance/change-status', [ShippingRateDistanceController::class, 'changeStatus'])->name('shipping-rate-distance.change-status');
Route::resource('shipping-rate-distance', ShippingRateDistanceController::class);
...
Route::put('genero-slider-section', [HomePageSettingController::class, 'updateProductSliderSectionGenero'])->name('genero-slider-section');
...
/** Retiro en tienda routes */
Route::get('retiro-en-tienda', [RetiroTiendaController::class, 'index'])->name('retiro-en-tienda.index');
Route::put('retiro-en-tienda/update/{id?}', [RetiroTiendaController::class, 'update'])->name('retiro-en-tienda.update');
Route::get('retiro-en-tienda/create', [RetiroTiendaController::class, 'create'])->name('retiro-en-tienda.create');
Route::post('retiro-en-tienda/store', [RetiroTiendaController::class, 'store'])->name('retiro-en-tienda.store');
Route::put('retiro-en-tienda/cambiar-estado', [ProductController::class, 'cambiarEstado'])->name('retiro-en-tienda.cambiar-estado');
Route::get('retiro-en-tienda/edit/{id}', [RetiroTiendaController::class, 'edit'])->name('retiro-en-tienda.edit');
Route::delete('retiro-en-tienda/destroy/{id}', [RetiroTiendaController::class, 'destroy'])->name('retiro-en-tienda.destroy');
...
/** politicas and privacidad */
Route::get('politica-and-privacidad', [PoliticaAndPrivacidadController::class, 'index'])->name('politica-and-privacidad.index');
Route::put('politica-and-privacidad/update', [PoliticaAndPrivacidadController::class, 'update'])->name('politica-and-privacidad.update');
