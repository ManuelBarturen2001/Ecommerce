...
@section('title')
{{$settings->site_name}} || Perfil de Usuario
@endsection
            ...
            <div class="wsus__dashboard_profile">
              <div class="wsus__dash_pro_area">
                ...
                <form action="{{route('user.profile.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-xl-12">
                        <button class="common_btn mb-4 mt-2" type="submit">Actualizar Perfil</button>
                    </div>
                </form>
                ...
                <div class="wsus__dash_pass_change mt-2">
                  <form action="{{route('user.profile.update.password')}}" method="POST">
                      ...
                      <div class="row">
                          ...
                          <div class="col-xl-12">
                            <button class="common_btn" type="submit">Actualizar Contraseña</button>
                          </div>
                      </div>
                  </form>
                </div>
