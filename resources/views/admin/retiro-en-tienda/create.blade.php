    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Añadir Nueva</div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.retiro-en-tienda.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nombre_tienda" value="{{ old('nombre_tienda') }}" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" name="horario_apertura" value="{{ old('horario_apertura') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" name="horario_cierre" value="{{ old('horario_cierre') }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="dias_disponibles" value="{{ old('dias_disponibles') }}" placeholder="Ej: Lunes a Viernes">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="longitud" id="longitud" value="{{ old('longitud') }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="instrucciones_retiro" rows="3">{{ old('instrucciones_retiro') }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label>Documentos Requeridos</label>
                                    <textarea class="form-control" name="documentos_requeridos" rows="3">{{ old('documentos_requeridos') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="estado" class="custom-switch-input" checked>
