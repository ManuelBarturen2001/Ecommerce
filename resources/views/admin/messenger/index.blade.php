      ...
      <div class="row align-items-center justify-content-center">
            ...
            <div class="card-body">
              <ul class="list-unstyled list-unstyled-border">
                ...
                <li class="media chat-user-profile" data-id="{{ $chatUser->senderProfile->id }}">
                  <img alt="imagen" class="mr-3 rounded-circle {{ $unseenMessages ? 'msg-notification' : '' }}" width="50" src="{{ asset($chatUser->senderProfile->image) }}">
                  <div class="media-body">
                    <div class="mt-0 mb-1 font-weight-bold chat-user-name">{{ $chatUser->senderProfile->name }}</div>
                    {{-- <div class="text-success text-small font-600-bold"><i class="fas fa-circle"></i> En línea</div> --}}
                  </div>
                </li>
                @endforeach
              </ul>
        ...
        <div class="col-md-9">
          <div class="card chat-box d-none" id="mychatbox" style="height: 70vh;">
            <div class="card-header">
              <h4 id="chat-inbox-title">Chat con Rizal</h4>
            </div>
            ...
            <div class="card-footer chat-form">
              <form id="message-form">
                <input type="text" class="form-control message-box" placeholder="Escribe un mensaje" name="message">
        ...
        $(document).ready(function(){
            $('.chat-user-profile').on('click', function(){
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        mainChatInbox.html("");
                        // establecer título del chat
                        $('#chat-inbox-title').text(`Chat con ${chatUserName}`)
                    },
