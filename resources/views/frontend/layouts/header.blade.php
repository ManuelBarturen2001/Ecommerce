...
<header>
    ...
    <div class="wsus__mini_cart">
        <h4><i class="fal fa-shopping-bag"></i> Carrito de compras <span class="wsus_close_mini_cart"><i class="far fa-times"></i></span></h4>
        <ul class="mini_cart_wrapper">
            @foreach (Cart::content() as $sidebarProduct)
                <li id="mini_cart_{{$sidebarProduct->rowId}}">
                    ...
                    <div class="wsus__cart_text">
                        ...
                        <small>Total de Variantes: {{$settings->currency_icon}}{{$sidebarProduct->options->variants_total}}</small>
                        <br>
            ...
            @if (Cart::content()->count() === 0)
                <li class="text-center">Tu Carro está vacío!</li>
                <li class="text-center">¡Aprovecha! Tenemos miles de productos en oferta y oportunidades únicas.</li>
            @endif
        </ul>
        <div class="mini_cart_actions {{Cart::content()->count() === 0 ? 'd-none': ''}}">
            ...
            <div class="wsus__minicart_btn_area">
                ...
                <a class="common_btn" href="{{route('user.checkout')}}">Ir a Pagar</a>
            </div>
        </div>
    </div>
