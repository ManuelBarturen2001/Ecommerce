...
@section('title')
{{$settings->site_name}} || Detalles del carrito
@endsection
...
@section('content')
                        ...
                        <div class="breadcrumb__content">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Vista del carrito</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
    ...
    <!--============================
        PÁGINA DE VISTA DEL CARRITO INICIO
    ==============================-->
            ...
            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table>
                                <tbody>
                                    ...
                                    <tr class="d-flex">
                                        <td class="wsus__pro_img"><img src="{{asset($item->options->image)}}" alt="producto"
                ...
                <div class="col-xl-3">
                    <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                        ...
                        <form id="coupon_form">
                            <input type="text" placeholder="Código del cupón" name="coupon_code" value="{{session()->has('coupon') ? session()->get('coupon')['coupon_code'] : ''}}">
                            <button type="submit" class="common_btn">aplicar</button>
                        </form>
                        <a class="common_btn mt-4 w-100 text-center" href="{{route('user.checkout')}}">pagar</a>
    ...
    <!--============================
          PÁGINA DE VISTA DEL CARRITO FIN
    ==============================-->
@endsection
...
<script>
    $(document).ready(function(){
        ...
        // obtener subtotal del carrito y ponerlo en el dom
