...
@section('title')
{{$settings->site_name}} || Productos del Vendedor
@endsection
                                        ...
                                        <div class="wsus__product_item">
                                            ...
                                            <div class="wsus__product_details">
                                                ...
                                                <p class="wsus__pro_rating">
                                                    ...
                                                    <span>({{count($product->reviews)}} reseña)</span>
                                                </p>
                                            ...
                                            <div class="wsus__product_details">
                                                ...
                                                <ul class="wsus__single_pro_icon">
                                                    ...
                                                    <form class="shopping-cart-form">
                                                        ...
                                                        @endforeach
                                                        <input class="" name="qty" type="hidden" min="1" max="100" value="1" />
                                                        <button class="add_cart_two mr-2" type="submit">añadir al carrito</button>
                                                    </form>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="wsus__pro_details_text">
                                    ...
                                    <p class="wsus__stock_area"><span class="in_stock">en stock</span> (167 artículos)</p>
                                    @if (checkDiscount($product))
