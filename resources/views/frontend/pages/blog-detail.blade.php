                ...
                <div class="col-xxl-9 col-xl-8 col-lg-8">
                    <div class="wsus__main_blog">
                        ...
                        <div class="wsus__comment_area">
                            <h4>Comentarios <span>{{count($comments)}}</span></h4>
                            @foreach ($comments as $comment)

                            <div class="wsus__main_comment">
                                <div class="wsus__comment_img">
                                    <img style="width: 80px;height: 80px;object-fit: contain;" src="{{asset($comment->user->image)}}" alt="usuario" class="img-fluid w-100">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="wsus__single_com">
                                            <textarea rows="5" placeholder="Tu comentario" name="comment"></textarea>
                                            <input type="hidden" name="blog_id" value="{{$blog->id}}">
                                        </div>
                                    </div>
                                </div>
                                <button class="common_btn" type="submit">Publicar comentario</button>
                            </form>
                            @else
                            <p>¡Por favor inicia sesión para comentar en la publicación!</p>
                        ...
                        <div class="wsus__blog_post">
                            ...
                            <div class="wsus__blog_post_single">
                                ...
                                <div class="wsus__blog_post_text">
                                    ...
                                    <p> <span>{{date('M d Y', strtotime($blog->created_at))}} </span> {{count($blog->comments)}} Comentarios </p>
                                </div>
                            </div>
                            @endforeach
